            ...
            <div className="max-w-full mx-auto px-3 py-4 space-y-4">
                ...
                <div className="flex items-around gap-2 justify-center flex-wrap ">
                    ...
                    <Link
                        ...
                        className="bg-yellow-600 flex-1 flex items-center justify-center text-center  font-bold rounded-md  text-white p-2 sm:px-4  sm:py-2  text-xs sm:text-sm hover:bg-yellow-700 transition">
                        Analysis
                    </Link>
                </div>
